...
export const wasmgame_procedural_v2_with_profile: (a: number, b: number, c: number, d: number, e: bigint, f: number, g: number, h: number) => void;
...
export const wasmgame_step_three_turn_search_replanned_cached: (a: number, b: number) => void;
...
export const wasmgame_three_turn_search_count: (a: number) => bigint;
export const wasmgame_three_turn_search_cache_hits: (a: number) => bigint;
